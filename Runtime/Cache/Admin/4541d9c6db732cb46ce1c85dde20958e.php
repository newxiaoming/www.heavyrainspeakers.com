			...
			<script type="text/javascript">
				...
				KindEditor.ready(function(K) {
					editor_<?php echo ($addons_data["name"]); ?> = K.create('textarea[name="<?php echo ($addons_data["name"]); ?>"]', {
						cssData: 'body {font: 400 12px/1.5 "PingFang SC","San Francisco","Helvetica Neue",Helvetica,Arial,"Hiragino Sans GB","Microsoft YaHei","WenQuanYi Micro Hei",sans-serif}',
