...
<script>
	...
	<!--<link href="/Public/static/css/upload.css" rel="stylesheet">-->
                        ...
                        <?php switch($field["type"]): case "num": ?><input type="text" class="text input-mid" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"><?php break;?>
								...
								<!--<div class="upload-box">-->
								    ...
								    <!--<div class="image-box clear">-->
								        <!--<section class="upload-section">-->
								            ...
								            <!--<input type="file" name="file" id="upload-input_<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"/>-->
								        <!--</section>-->
								    <!--</div>-->
								<!--</div>-->
                            ...
                            <!--<script type="text/javascript">
									...
									uploader.on( 'uploadSuccess', function( file,response ) {
										...
										$("#cover_id_<?php echo ($field["name"]); ?>").val(response.id);
									...
									function webUpload(id) {
									    $("#filePicker_"+id).addClass("filePicker");
									}
								</script>-->
