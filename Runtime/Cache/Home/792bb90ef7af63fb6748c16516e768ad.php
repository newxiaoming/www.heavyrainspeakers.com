...
<!-- 背景 end -->
                ...
                <div class="g-center">
                    ...
                    <script id="tpl-main" type="text/html">
                        <h2 class="case-list__title">{{ title }}</h2>
                        <div class="case-list__list">
                            <ul>                                
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><!-- 单个案例 start item/case-item -->
                                    <li>
                                    ...
                                    <!-- 单个案例 end --><?php endforeach; endif; else: echo "" ;endif; ?>    
                            </ul>
                        </div>
                        <div class="g-main">
                            <div class="g-shape4"></div>
                            <div class="g-tab">{{ partner }}</div>
                        </div>
                        <div class="case-list__partner">
                                <?php echo hook('linkspartner', 1);?>
                        </div>
                    </script>
                    <script>
                        i18next.init({
