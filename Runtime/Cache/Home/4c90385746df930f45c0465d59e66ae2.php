                ...
                <div class="g-center">
                    ...
                    <script id="tpl-main" type="text/html">
                        ...
                        <div class="news__article">
                            <img src="<?php echo (get_cover($info["cover_id"],'path')); ?>" alt="<?php echo ($info["title"]); ?>" width="1150" height="325">
                            <div class="g-main">
                                <h1><?php echo ($info["title"]); ?></h1>
                                <span>日期：<?php echo (date('Y年m月d日',$info["create_time"])); ?></span>
                                <?php echo ($info["content"]); ?>
                                <div class="g-shape5"></div>
                            </div>
                        </div>
                    </script>
                    <script>
